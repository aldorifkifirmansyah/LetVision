...
import { DiseaseInstruction } from "../components/DiseaseInstruction";
import { DiseaseActionButtons } from "../components/DiseaseActionButtons";

type RootStackParamList = {
  DiseaseResult: { predictions: any; imageUri: string };
};

type NavigationProp = StackNavigationProp<RootStackParamList, "DiseaseResult">;
